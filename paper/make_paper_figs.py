#!/usr/bin/env python3
"""Publication figures for the World Cup paper, vector PDF, Times-matching style. Out: paper/figs/*.pdf"""
...
O=os.path.join(R,"analysis","out"); F=os.path.join(R,"paper","figs"); os.makedirs(F,exist_ok=True)
